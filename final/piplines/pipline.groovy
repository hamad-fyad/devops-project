...
PROP = [:]
//todo change the github webhook url
PROP['git_cred'] = 'hamad-fyad-githubToken'
PROP['branch'] = 'main'
PROP['proj_url'] = 'https://github.com/hamadfyad/devops-project.git'

PROP['dockerhub_cred'] = 'dockerhub_cred' // Jenkins credential ID for DockerHub
PROP['docker_image1'] = 'hamadfyad/poly'
PROP['docker_image2'] = 'hamadfyad/yolo'
PROP['docker_tag'] = '1.7'
PROP['aws_cli_cred'] = 'hamad-aws-cred'

PROP['project_folder_name'] = 'final'
PROP['cluster_region'] = 'us-east-1'
PROP['cluster_name'] = 'Atech'
PROP['helm_sh'] = 'helm install hamadtest -f values.yaml -n hamad .'
            ...
            steps {
                script {
                    ...
                    withCredentials([file(credentialsId: 'alb2_cert', variable: 'CREDENTIAL_FILE')]) {
                        ...
                        def destinationDir = '/home/ubuntu/workspace/<nameOfJenkinspipeline>/final/aws_project/polybot'  // Replace with your actual destination directory
